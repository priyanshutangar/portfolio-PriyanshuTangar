        ...
        <div className="flex justify-center space-x-8">
          {Object.entries(socialLinks).map(([platform, link]) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 flex items-center justify-center glass-effect rounded-full border border-blue-500/10 hover:border-blue-500/30 group">
                  <Icon className="text-3xl text-blue-400 group-hover:text-blue-300 transition-colors" />
                </div>
              </a>
            );
          })}
